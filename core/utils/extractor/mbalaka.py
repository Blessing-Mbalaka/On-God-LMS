...
def _images_md(block: Block) -> str:
    parts = []
...
def _ollama_classify_with_md(paper: Paper, markdown: str) -> Optional[List[Dict[str, Any]]]:
...
def classify_blocks_with_markdown(paper: Paper) -> Dict[str, Any]:
