...
def _ollama_suggest(paper: ExtractorPaper, blocks: List[ExtractorBlock]) -> Optional[List[Dict[str, Any]]]:
...
def suggest_boxes_for_paper(paper: ExtractorPaper) -> List[Dict[str, Any]]:
    """
